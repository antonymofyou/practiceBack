...
while ($homeTasksRequest = $stmt->fetch(PDO::FETCH_ASSOC)) {
    ...
    $homeTasks[] = [
        'htNum' => (string)$daysData['ht_num'],
        'videoId' => (string)$daysData['video_id'],
        'forOrder' => (string)$daysData['for_order'],
        'access' => (string)$daysData['access'],
        'views' => (string)$prosmotrov,
        'htStatus' => (string)$daysData['ht_status'],
        'htUserBallovP1' => (string)$daysData['ht_user_ballov_p1'],
        'htUserMaxballovP1' => (string)$daysData['ht_user_maxballov_p1'],
        'htUserStatusP1' => (string)$daysData['ht_user_status_p1'],
        'htUserDateP1' => (string)$daysData['ht_user_date_p1'],
        'htUserBallovP2' => (string)$daysData['ht_user_ballov_p2'],
        'htUserMaxballovP2' => (string)$daysData['ht_user_maxballov_p2'],
        'htUserStatusP2' => (string)$daysData['ht_user_status_p2'],
        'htUserDateP2' => (string)$daysData['ht_user_date_p2']
    ];
}
$stmt->closeCursor();
unset($stmt);
